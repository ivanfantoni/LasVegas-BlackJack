...
#------------------------------------------------------------------
    ...
    def moneybox_split(self, x1, y1, x2, y2):
        ...
        self.mb1 = money_im
        self.ms1 = self.bc.create_image(x1, y1, image=money_im, anchor='nw')
        self.mbtext1 = self.bc.create_text(x1+34, y1+35, text=self.game._bet.amount, fill='white', font='ubuntu', anchor='center')
        self.ms2 = self.bc.create_image(x2, y2, image=money_im, anchor='nw')
    ...
    def moneybox_insurance(self, x, y):
        ...
        self.mbins = self.bc.create_image(x, y, image=money_im, anchor='nw')
